        ...
        <Container>
            <Row>
                {firstRow.map(character => {
                    return <Col><CharacterCard name={character.name} image={character.image}location={character.location.name} status={character.status} species={character.species}></CharacterCard></Col>
                })}
            </Row>
            <Row>
